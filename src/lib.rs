...
#[derive(Debug)]
pub struct NFTVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NFTVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NFTVault processing");
    
    let mut processor = NFTVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NFTVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NFTVaultProcessor::new(false);
